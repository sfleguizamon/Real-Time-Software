...
#define  DIO_TASK_PRIO             15
#define  DIO_TASK_DLY_TICKS        100
#define  DIO_TASK_STK_SIZE        256

#define  DIO_MAX_DI                8       /* Maximum number of Discrete Input  Channels (1..255)     */
#define  DIO_MAX_DO                36       /* Maximum number of Discrete Output Channels (1..255)     */
...
#define DIO_PA11 	11
#define DIO_PA12 	12
// #define DIO_PA13 	13     	/* NC */
// #define DIO_PA14 	14		/* NC */
#define DIO_PA15 	15
